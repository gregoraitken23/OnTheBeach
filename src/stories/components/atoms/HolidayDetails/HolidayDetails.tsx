...
export const HolidayDetails = ({
  ...
  return (
    ...
    <div className="hotelDetails-information">
     <p>
      <b>{adults}</b> {adultPassengerText},
      <b> {children}</b> {childPassengerText} {infantsExist && ' & '}
      <b> {infants}</b> {infantPassengerText}<br/>
      <b>{departureDateString}</b> for <b>{nights}</b> nights<br/>
